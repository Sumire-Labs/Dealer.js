...
export const SETTING_CATEGORIES: readonly CategoryMeta[] = [
    {
        ...
        emoji: '\u{1F4B0}',
        label: '経済',
        settings: [S.initialChips, S.bankInterestRate, S.dailyBonus, S.dailyBonusBroke, S.missionCompleteBonus]
    },
    {
        id: 'bet',
        emoji: '\u{1F3B2}',
    ...
    },
    {
        ...
        emoji: '\u{1F3E6}',
        label: 'ローン',
        settings: [S.loanMaxTotal, S.loanMinAmount, S.loanMaxAmount, S.loanInterestRate]
    },
    {
        id: 'bankruptcy',
        emoji: '\u{1F480}',
        label: '破産',
        settings: [S.bankruptcyChips, S.bankruptcyPenaltyRate, S.bankruptcyPenaltyDuration]
    },
    {
        id: 'work',
        emoji: '\u{1F4BC}',
        label: '労働',
        settings: [S.workShortCD, S.workNormalCD, S.workLongCD, S.workEmergencyCD, S.tipMin, S.tipMax, S.streakMaxBonus, S.multiStepChance]
    },
    {
        id: 'heist',
        emoji: '\u{1F52B}',
        label: '強盗',
        settings: [S.heistMinEntry, S.heistBaseRate, S.heistPerPlayerBonus, S.heistMaxRate, S.heistMinRate, S.heistSoloPenalty, S.heistChannelCD]
    },
    {
        id: 'prison',
        emoji: '\u{1F46E}',
        label: '刑務所',
        settings: [S.prisonDuration, S.prisonFine, S.prisonJailbreakRate, S.prisonJailbreakPenalty]
    },
    {
        id: 'lottery',
        emoji: '\u{1F3AB}',
        label: '宝くじ',
        settings: [S.lotteryTicketPrice, S.lotteryMaxTickets, S.lotteryJackpotRate, S.lotterySecondRate, S.lotteryHouseRate]
    },
    {
        id: 'poker',
        emoji: '\u{1F0CF}',
        label: 'ポーカー',
        settings: [S.pokerMinBuyin, S.pokerMaxBuyin, S.pokerActionTimeout]
    },
    {
        id: 'business',
        emoji: '\u{1F3E2}',
        label: 'ビジネス',
        settings: [S.businessUnlockLevel, S.businessEmployeeMax, S.businessOwnerBonus, S.businessSalaryRate, S.businessEventChance]
    },
    {
        id: 'team',
        emoji: '\u{1F465}',
        label: 'チーム',
        settings: [S.teamShiftBonus, S.teamShortCD, S.teamNormalCD, S.teamLongCD, S.overtimeMaxRounds, S.overtimeRisk, S.weeklyAllBonus]
    },
    {
        id: 'fixedDeposit',
        emoji: '\u{1F4CC}',
        label: '定期預金',
        settings: [S.fixedDeposit7dMultiplier, S.fixedDeposit30dMultiplier, S.fixedDepositMinAmount, S.fixedDepositMaxSlots]
    },
];
