...
export function buildDebugTabView(data: DebugViewData, adminId: string, tab: DebugTab): ContainerBuilder {
    switch (tab) {
        case 'economy':
            return buildDebugEconomyView(data, adminId);
        case 'work':
            return buildDebugWorkView(data, adminId);
        case 'business':
            return buildDebugBusinessView(data, adminId);
        case 'reset':
            return buildDebugResetView(data, adminId);
    }
}
