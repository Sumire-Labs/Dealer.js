...
function evaluate5(cards: Card[]): HandResult {
    ...
    if (isFlush && isStraight) {
        ...
        return {
            ...
            score: computeScore(HandRank.StraightFlush, [straightHigh]),
    ...
    if (groups[0][1] === 4) {
        ...
        return {
            ...
            score: computeScore(HandRank.FourOfAKind, [quad, kicker]),
    ...
    if (groups[0][1] === 3 && groups[1][1] === 2) {
        ...
        return {
            ...
            score: computeScore(HandRank.FullHouse, [trips, pair]),
    ...
    if (isFlush) {
        return {
            rank: HandRank.Flush,
            score: computeScore(HandRank.Flush, values),
    ...
    if (isStraight) {
        return {
            ...
            score: computeScore(HandRank.Straight, [straightHigh]),
    ...
    if (groups[0][1] === 3) {
        ...
        return {
            ...
            score: computeScore(HandRank.ThreeOfAKind, [trips, ...kickers]),
    ...
    if (groups[0][1] === 2) {
        ...
        return {
            ...
            score: computeScore(HandRank.OnePair, [pair, ...kickers]),
    ...
    return {
        ...
        score: computeScore(HandRank.HighCard, values),
