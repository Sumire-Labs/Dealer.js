...
async function handleTeamButton(interaction: ButtonInteraction): Promise<void> {
    ...
    switch (action) {
        case 'create':
            return handleCreate(interaction, userId, parts);
        case 'join':
            return handleJoin(interaction, userId, parts);
        case 'cancel':
            return handleCancel(interaction, userId, parts);
        case 'start':
            return handleStart(interaction, userId, parts);
        case 'job':
            return handleJob(interaction, userId, parts);
    }
}
